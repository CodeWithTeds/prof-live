    ...
    <div id="mobile-sidebar"
        ...
        <div class="h-16 flex items-center px-4 border-b border-neutral-200 dark:border-neutral-800">
            ...
            <button id="close-sidebar"
                class="ml-auto p-2 rounded-md hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
            ...
            <ul class="space-y-1">
                <li>
                    <a href="{{ route('admin.dashboard') }}"
                        class="flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors">
    ...
    <div class="min-h-screen md:grid md:grid-cols-[16rem,1fr]">
        ...
        <aside class="hidden md:flex md:flex-col w-64 bg-gray-100 dark:bg-gray-900 shadow-lg">
            <nav class="p-4 space-y-1">
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium hover:bg-neutral-100 dark:hover:bg-neutral-800">
        ...
        <div class="flex flex-col min-h-screen">
            <!-- Header -->
            <header
                class="h-16 sticky top-0 z-40 flex items-center gap-3 border-b border-neutral-200 dark:border-neutral-800 bg-white/80 dark:bg-neutral-900/80 px-4">
